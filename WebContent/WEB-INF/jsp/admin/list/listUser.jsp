...
<div class="user-list">
    <div class="user-list-container table-responsive">
      <table id="user-list-table" class="base-table table table-hover table-responsive">
        <tr>
        ...
        <tr>
          ...
          <td class="op">
            <span class="edit-user-link glyphicon glyphicon-edit"></span>
            <span class="del-user-link glyphicon glyphicon-trash"></span>
          </td>
        </tr>
